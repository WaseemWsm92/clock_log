...
import { Checkbox, Col, Modal, Pagination, Row } from "antd";
  ...
  return (
    <div>
      ...
      >
        ...
        <div className="projects-checkboxes checkboxes-wrapper">
          <Checkbox.Group options={teams} onChange={onChange}  className="checkboxes-wrapper"/>
         </div>
        </Col>
        </Row>
        <Pagination
